...
//                Snackbar.make(view, "加载失败！", Snackbar.LENGTH_SHORT).show();
    ...
    private static class SendRecyclerViewAdapter extends RecyclerView.Adapter<SendRecyclerViewAdapter.MyViewHolder> implements ItemTouchHelperAdapter {
        private List<String> mData;
        ...
        @Override
        public SendRecyclerViewAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
...
//            });
        ...
        @Override
        public void onBindViewHolder(final SendRecyclerViewAdapter.MyViewHolder holder, final int position) {
        ...
        public class FooterViewHolder extends SendRecyclerViewAdapter.MyViewHolder {
